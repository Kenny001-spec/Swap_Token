...
contract UsdtToken {
    ...
    function transfer(address _reciever, uint256 _amountOfToken) external {
        require(_reciever != address(0), "This address is not allowed");
    ...
    function approve(address _delegate, uint256 _amountOfToken) external {
        require(balances[msg.sender] > _amountOfToken, "Your balance is not enough");
    ...
    function allowance(address _owner, address _delegate) external view
        returns (uint256)
    {
